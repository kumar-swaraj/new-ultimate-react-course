...
function App() {
  // Components contains - data, logic and appearance
  // Each components needs to return a block of JSX
  return (
...
function Header() {
  // const style = { color: 'red', fontStyle: 'italic', textAlign: 'center' };
...
function Footer() {
  ...
  return (
    <footer className="footer">
      ...
      {/* React never render booleans in DOM i.e., true or false */}
      {/* {isOpen && (
        <div className="order">
          <p>
  ...
  // JSX always converted to React.createElement by Babel.
